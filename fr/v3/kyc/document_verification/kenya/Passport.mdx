...
description: "Extrayez les détails d'identité d'un passeport kényan à l'aide de l'OCR."
openapi: "POST /api/onboarding/document_verification/kenya/passport"
---

Vérifiez le passeport kényan d'un client en téléversant une photo de la page de données — aucune saisie manuelle du numéro de passeport requise. Extraction OCR plus une concordance faciale requise par rapport à un selfie — pas de vérification de vivacité (pas de vidéo, pas de défi de clignement/mouvement).
