...
Verifying a customer using their Voters' Identification Number (VIN) with ZeeH's endpoint allows you to access verified national-level information. The VIN is a 19-digit value located at the top of a voter's card. The state of origin and surname are also required.
