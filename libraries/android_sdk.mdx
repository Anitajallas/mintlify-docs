...
| Failure | Pre-submission errors only: camera denied, config or network failure, liveness timeout. Offers **Try Again** |
...
The flow carries your brand, not Adhere's. Colour, name, description and logo all
