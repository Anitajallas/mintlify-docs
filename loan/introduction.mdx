...
## Technical Overview
    ...
    Upon receiving a loan application, the system calls the Zeeh API to retrieve the applicant’s credit history. This data, combined with the application’s financial and personal details, is processed to compute the fraud risk score.
