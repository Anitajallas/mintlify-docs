...
  "account_type": "individual", //individual or corporate
  "origin_account": {
...
    "customer_email": "Tila.doe@example.com",
    "bvn": "22430372151"
  },
  "additional_info": {
...
  },
  "run_kyc": false //set to true when needed
}
```
...
| `transaction_type`  | Type of the transaction (transfer, card, ussd, web)                           | `String` |
...
| `- bvn`              |  Customer's BVN (used in building a profile for the customer. Optional)            | `String` |
