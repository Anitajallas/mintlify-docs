...
|-----------|------|----------|-------------|
| `image` | string | Yes | URL of the short selfie video to check for liveness (recommended). Video formats: `.mp4`, `.mov`, `.webm`, `.avi`, `.m4v` — anything else is treated as a still image, which is also accepted. |
