...
| `image` | string | No | **Deprecated** alias for `live_media`, kept for backward compatibility with existing integrations. Use `live_media` for new integrations — if both are sent, `live_media` takes precedence. |
