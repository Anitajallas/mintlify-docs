...
Verify a customer's Ghanaian passport by uploading a photo of the data page — no manual passport number entry required. Extraction only; no face match, no liveness check.
