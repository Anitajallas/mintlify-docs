...
Verify a customer's Kenyan passport by uploading a photo of the data page — no manual passport number entry required. Extraction only; no face match, no liveness check.
