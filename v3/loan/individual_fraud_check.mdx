...
| `identifier` | number | Yes | Customer identifier value (e.g. BVN for Nigeria, a Kenya national ID number) |
| `identifier_type` | string | Yes | Key of the identifier type (e.g. `bvn`, `national_id`, `ghana_card`) |
