...
| `bvn` | string | Yes | 11-digit Bank Verification Number (Nigeria). Use `identifier` + `identifier_type` for other countries |
| `identifier` | string | No | Customer identifier for non-Nigeria applicants (e.g. a Kenya national ID number) |
